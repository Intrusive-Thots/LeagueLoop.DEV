...
- `tests/`: Pytest suite (183 passing unit & integration test cases).
...
- 100% module docstring compliance achieved across all `src/` modules, services, API routes, and automation handlers.
